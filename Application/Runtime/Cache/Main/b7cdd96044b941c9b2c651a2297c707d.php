...
<div class="main">
    <a href="<?php echo U('Area/add');?>">添加大区</a>
	<!-- 
	<select>
    ...
    <table>
        ...
        <?php if(is_array($_list)): foreach($_list as $key=>$item): ?><tr>
                <td>
					<input type="hidden" id="id" value="<?php echo ($item["area_id"]); ?>" />
                ...
                <td>
                    <a href="<?php echo U('dodel',array('area_id'=>$item['area_id']));?>">删除</a>
					<a href="<?php echo U('edit',array('area_id'=>$item['area_id']));?>">编辑</a>
                </td>
